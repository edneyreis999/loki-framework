...
type: agent
status: draft
description: Consolidar handoffs de especialistas game-dev em requisitos testaveis, rastreaveis e coerentes sem escrever em runtime nem depender de engine.
mode: proposal-only
confidence: medium
model: inherit
...
adapter_projection:
  claude_code: "Pode ser projetado como subagent proposal-only para sintese final de requisitos game-dev."
  codex: "Projetado em codex/agents/game-business-analyst.toml com sandbox read-only e high reasoning effort."
nickname_candidates:
