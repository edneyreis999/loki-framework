...
adapter_projection:
  ...
  codex: "Projetado em codex/agents/quest-content-designer.toml com sandbox workspace-write; escrita limitada por contrato ao target_inventory_dir de loki:init ou aos target_files da task aprovada."
nickname_candidates:
