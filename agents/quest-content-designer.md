...
durable_context_root: "docs/loki-init/quest-content-designer/"
...
completion_criteria: "Init packets or exact-target quest result delivered with validators, gates, risks and compact completion record; execution evidence remains orchestrator-owned."
...
adapter_projection:
  ...
  codex: "Projetado em codex/agents/quest-content-designer.toml; init sem escrita e task write limitada aos target_files exatos apos preflight aplicavel."
nickname_candidates:
...
- `quest-content-designer.quests-objectives` (`deep`)
- `quest-content-designer.npcs-steps` (`deep`)
- `quest-content-designer.rewards` (`deep`)
- `quest-content-designer.flags` (`deep`)
- `quest-content-designer.preconditions` (`deep`)
- `quest-content-designer.postconditions` (`deep`)
- `quest-content-designer.source-map` (`map`)
...
- Handoff estruturado para `narrative-designer`, `game-designer`,
  `level-designer`, `balance-economy-designer`, `narrative-qa`,
  `technical-implementer` ou `game-business-analyst`.
