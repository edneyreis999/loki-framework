...
`standards-curator`, `catalogador`, `loki-skill-creator` ou outro destino
quando apropriado.
...
retrospective_digest:
  ...
  conflicts_or_weak_evidence:
    - description: ""
      affected_candidates: []
      needed_resolution: "orchestrator-review | standards-curator | source-researcher | catalogador | loki-skill-creator | human-interview | validator | backlog"
  human_decisions: []
