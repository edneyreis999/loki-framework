...
durable_context_root: "docs/loki-init/game-product-owner/"
...
completion_criteria: "Init packets or exact-target product result delivered with validators, gates, risks and compact completion record; execution evidence remains orchestrator-owned."
...
required_skills:
  ...
  - "rpg-maker-mz-visustella-plugin-index quando valor, escopo ou criterio de aceite de RPG Maker MZ depender de recurso VisuStella, VisuMZ_, tier, plugin order ou plugin incerto"
  - "rpg-maker-mz-visustella-battle-mechanics quando a promessa de produto depender de combate, ATB, TP, AI, Aggro ou feedback de batalha VisuStella"
  - "rpg-maker-mz-visustella-progression-economy quando a promessa de produto depender de progressao, AP/SP, lojas, moedas, skills, itens ou equipamentos VisuStella"
  - "rpg-maker-mz-visustella-events-presentation quando a promessa de produto depender de mensagem, Visual Novel, busts, pictures, options, save ou apresentacao VisuStella"
required_gates:
  - technical-review
...
adapter_projection:
  ...
  codex: "Projetado em codex/agents/game-product-owner.toml; init sem escrita e task write limitada aos target_files exatos apos preflight aplicavel."
nickname_candidates:
  - game-product-owner
  - game-po
---
...
- `game-product-owner.product-promise` (`deep`)
- `game-product-owner.current-scope` (`deep`)
- `game-product-owner.documented-priorities` (`deep`)
- `game-product-owner.personas-audience` (`deep`)
- `game-product-owner.milestones` (`deep`)
- `game-product-owner.roadmap-brief-sources` (`map`)
