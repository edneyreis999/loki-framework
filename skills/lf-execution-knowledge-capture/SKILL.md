...
when_to_use:
  - "Use when loki-agentic-development or loki-run-plan reaches a checkpoint with material attempts, errors, recovery, validation, environment, handoff, liveness or state friction."
...
type: skill
status: draft
used_by: [loki-agentic-development, loki-run-plan, execution-knowledge-cataloger]
---
...
1. At the normal task or agent checkpoint, persist the minimal sanitized
