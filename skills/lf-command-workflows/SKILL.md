...
when_to_use:
  - "Use when routing one of the 17 public Loki command bundles available to consumer and package profiles."
...
type: skill
status: draft
used_by: [loki-init, loki-catalogar-docs, loki-criar-branch, loki-commit, loki-abrir-pr, loki-continuous-improvement, loki-enrich-tasks, loki-feedback, loki-generate-action-plan, loki-human-decision-preflight, loki-agentic-development, loki-deep-analysis, loki-deep-research, loki-retrospectiva-tecnica, loki-run-plan, loki-demand-text-improver, loki-tech-analysis]
---
