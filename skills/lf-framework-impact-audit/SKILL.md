...
description: Audit how extracted external learnings may impact concrete Loki Framework artifacts, workflows, commands, skills, templates, docs, validators, or manifest entries. Use after lf-external-knowledge-extraction or when comparing candidate learnings against docs/operational-inventory.md.
when_to_use:
