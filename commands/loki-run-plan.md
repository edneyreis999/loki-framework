...
- `lf-run-plan-execution` para preflight da fase, leitura de tasks, selecao de contexto, ordem de execucao, validators e estado retomavel.
...
3. Carregar `lf-run-plan-execution`.
